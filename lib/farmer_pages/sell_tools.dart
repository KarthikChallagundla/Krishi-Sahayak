...
class SellTools extends StatefulWidget {
  final String user;
  const SellTools({super.key, required this.user});

  @override
  State<SellTools> createState() => _SellToolsState();
}
                ...
                onPressed: () async {
                  if(formkey.currentState!.validate()){
                    ...
                    try {
                      ...
                      Reference ref = FirebaseStorage.instance.ref().child('tools_images/$fileName.jpg');
                      ...
                      createProduct('tools', name, description, price, quantity, widget.user, downloadUrl);
