                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          CircleAvatar(
                            radius: 40,
                            backgroundImage: (doctorsData[index]['imgUrl'].toString().isNotEmpty) ? NetworkImage(doctorsData[index]['imgUrl']) : null,
                            child: (doctorsData[index]['imgUrl'].toString().isEmpty) ? Text('No Image', style: TextStyle(fontSize: 12),) : null,
                          ),
                          SizedBox(width: 15),
                          Expanded(
                            child: Column(
